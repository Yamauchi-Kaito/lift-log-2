...
const section = { paddingTop: 18 } as const
const header = { display: "flex", alignItems: "center", gap: 10, marginBottom: 24 } as const
...
const heading = { margin: "3px 0 0", color: "#f2f2f2", fontFamily: "Outfit", fontSize: 20, fontWeight: 700 } as const
const hint = { margin: "0 0 16px", color: "#666", fontSize: 12 } as const
const field = { display: "block", marginTop: 14, color: "#aaa", fontFamily: "Inter", fontSize: 12 } as const
const input = { display: "block", boxSizing: "border-box", width: "100%", height: 48, marginTop: 7, padding: "0 12px", border: "1px solid #333", borderRadius: 9, outline: "none", background: "#181818", color: "#eee", fontFamily: "Inter", fontSize: 16 } as const
