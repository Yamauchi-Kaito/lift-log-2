...
export default function TeamManageScreen({ teamName, members, records, currentRole, saving, error, onBack, onRoleChange, onRemoveRecord }: { teamName: string; members: TeamMember[]; records: SharedRecord[]; currentRole: TeamRole; saving: boolean; error: string | null; onBack: () => void; onRoleChange: (id: string, role: "Admin" | "Member") => Promise<boolean>; onRemoveRecord: (id: string) => void }) {
